...
DonationFundlistModel donationFundlistModelFromJson(String str) => DonationFundlistModel.fromJson(json.decode(str));

String donationFundlistModelToJson(DonationFundlistModel data) => json.encode(data.toJson());

class DonationFundlistModel {
  String responseCode;
  String result;
  String responseMsg;
  List<Fundlist> fundlist;

  DonationFundlistModel({
  ...
  factory DonationFundlistModel.fromJson(Map<String, dynamic> json) => DonationFundlistModel(
